...
public static class ServiceExtensions
{
    ...
    {
        services.AddCors(opt => opt.AddPolicy("localhost", p => { p.WithOrigins("http://127.0.0.1:5000", "http://127.0.0.1:4200", "https://amr.team", "http://localhost:4200").AllowAnyHeader().AllowAnyMethod().AllowCredentials(); }));
